...
class DocumentTemplate(models.Model):
    ...
    # Типы документов - обновлено согласно требованиям
    DOCUMENT_TYPES = (
        ('all_orders', '📝 Распоряжения о стажировке'),  # Объединенный шаблон
        ('knowledge_protocol', '📋 Протокол проверки знаний по охране труда'),
        ('doc_familiarization', '📝 Лист ознакомления с документами'),
        ('siz_card', '🛡️ Карточка учета СИЗ'),  # Добавлен новый тип документа
    )
