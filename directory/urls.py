...
from directory.views import (
    EmployeeHiringView,          # 🏠 Главная страница
...
employee_patterns = [
    path('', EmployeeListView.as_view(), name='employee_list'),  # 👥 Список сотрудников
...
position_patterns = [
    path('', PositionListView.as_view(), name='position_list'),  # 👔 Список должностей
